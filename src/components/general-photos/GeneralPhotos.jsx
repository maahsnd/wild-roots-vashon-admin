...
function GeneralPhotos() {
  ...
  return (
    <div className={styles.container}>
      ...
      <button onClick={()=> setPageName('aboutPhotos')} className={styles.pageBtn}>About</button>
      <button onClick={()=> setPageName('farmPhotos')} className={styles.pageBtn}>Farm</button>
      </div>
